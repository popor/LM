...
@interface PoporAvPlayerBrightnessView ()
...
@implementation PoporAvPlayerBrightnessView

#pragma mark - singleton
+ (instancetype)sharedBrightnessView {
    static PoporAvPlayerBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[PoporAvPlayerBrightnessView alloc] init];
    });
    return instance;
}
