...
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(KCvDelegate_ShakeDelayTime * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{ if ([CcAnimationShake share].shakeIP) { FeedbackShakeLight; } });\
}\
\
- (void)collectionView:(UICollectionView *)colView didUnhighlightItemAtIndexPath:(NSIndexPath *)indexPath {\
