...
dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(KTvDelegate_ShakeDelayTime * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{ if ([CellAnimationShake share].shakeIP) { FeedbackShakeLight; } });\
}\
\
- (void)tableView:(UITableView *)tableView didUnhighlightRowAtIndexPath:(NSIndexPath *)indexPath {\
